...
func AllTools() []Tool {
	return []Tool{
		...
		{
			Name:        "indoor_api",
			Description: "Access Indoor GIS operations through a strict allowlist. Mutating operations require confirm=true.",
			InputSchema: InputSchema{
				Type: "object",
				Properties: map[string]PropertySchema{
					"operation": {
						Type:        "string",
						Description: "Indoor operation name.",
						Enum: []string{
							"list_campuses", "create_campus", "get_campus", "update_campus", "delete_campus", "list_campus_buildings",
							"list_buildings", "create_building", "get_building", "update_building", "delete_building",
							"list_floors", "create_floor", "upload_floor_plan", "list_floor_spaces",
							"create_space", "get_space", "update_space", "delete_space", "list_transitions",
							"list_boundaries", "create_boundary", "get_boundary", "update_boundary", "delete_boundary",
							...
							"topology_resilience", "topology_track", "topology_compare", "spectral_analysis",
							"evacuation_optimal", "simulate_fire_evacuation",
							"simulate_airflow", "simulate_acoustics", "simulate_thermal", "simulate_rf",
							"navigate_manifold", "forecast", "simulate_infection_risk",
						},
					},
					"building_id": {Type: "string", Description: "Path parameter for building-scoped operations."},
					"campus_id":   {Type: "string", Description: "Path parameter for campus-scoped operations."},
					"floor_id":    {Type: "string", Description: "Path parameter for floor-scoped operations."},
					"level":       {Type: "string", Description: "Path parameter for floor level routes."},
					"space_id":    {Type: "string", Description: "Path parameter for space-scoped operations."},
					"asset_id":    {Type: "string", Description: "Path parameter for asset-scoped operations."},
					"boundary_id": {Type: "string", Description: "Path parameter for boundary-scoped operations."},
